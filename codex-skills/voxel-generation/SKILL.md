...
4. Generate the orthographic source sheet as a separate image. Use `references/source_sheet_prompt_template.md` to fill a concrete prompt from the approved style reference and confirmed scale contract. Do not freehand production prompts.
